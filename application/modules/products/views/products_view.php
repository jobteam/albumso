...
<div class="main-container">
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-3 vendor-box"><!-- venue box start-->
        <div class="vendor-image"><!-- venue pic --> 
          <a href="#"><img src="<?php echo base_url() ?>public_html/images/vendor-7.jpg" alt="wedding venue" class="img-responsive"></a>
          <div class="favourite-bg"><a href="#" class=""><i class="fa fa-heart"></i></a></div>
        </div>
        <!-- /.venue pic -->
        <div class="vendor-detail"><!-- venue details -->
      ...
      <div class="col-md-3 vendor-box"><!-- venue box start-->
        <div class="vendor-image"><!-- venue pic --> 
          <a href="#"><img src="<?php echo base_url() ?>public_html/images/vendor-8.jpg" alt="wedding venue" class="img-responsive"></a>
          <div class="favourite-bg"><a href="#" class=""><i class="fa fa-heart"></i></a></div>
        </div>
        <!-- /.venue pic -->
        <div class="vendor-detail"><!-- venue details -->
