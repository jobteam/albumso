 ...
 * Project Name: albumso
 * File Name: place_view_new.php
 * Date: 2016.09.06
 * Time: 12.00.00
 * Copyright (C) BanhBao.
 */
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="page-header">
                    <h1>Tổng hợp những địa điểm chụp hình cưới đẹp ở Việt Nam</h1>
                </div>
            </div>
        </div>
    </div>
...
<div class="tp-breadcrumb">
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                <ol class="breadcrumb">
                    <li><a href="#">Trang home</a></li>
                    <li class="active">Địa điểm đẹp</li>
                </ol>
            </div>
        </div>
    </div>
                ...
                <div class="row">
                    <div class="col-md-12 post-holder">
                        <div class="well-box">
                            ...
                            <!-- blog holder -->
                            <div class="post-image"><a href="#"><img src="<?php echo base_url('public_html/images/post-pic-2.jpg')?>" class="img-responsive" alt=""></a></div>
                    ...
                    <div class="col-md-12 post-holder"><!-- blog holder -->
                        <div class="well-box">
                            <div class="post-image"><a href="#"><img src="<?php echo base_url('public_html/images/post-pic.jpg')?>" class="img-responsive" alt=""></a></div>
                    ...
                    <div class="col-md-12 post-holder "><!-- blog holder -->
                        <div class="well-box">
                            <div class="post-image"><a href="#"><img src="<?php echo base_url('public_html/images/post-pic-3.jpg')?>" class="img-responsive" alt=""></a></div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 widget widget-tag"><!-- widget -->
                        <div class="well-box">
                            ...
                            <a href="#">Đà Lạt</a> <a href="#">Vũng Tàu</a> <a href="#">Hồ Cốc</a> <a href="#">Hotel</a> <a href="#">Garden Wedding</a> <a href="#">Boutique</a> <a href="#">Intimate</a>
