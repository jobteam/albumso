...
<div class="container venue-header">
    <div class="row venue-head">
        ...
        <div class="col-md-4 venue-action"> <a href="#googleMap" class="btn tp-btn-primary">VIEW MAP</a> <a href="<?php echo base_url(); ?>provider/profile" class="btn tp-btn-default">Profile</a> </div>
    </div>
</div>
        ...
        <div class="row">
            ...
            <div class="col-md-3 vendor-box"><!-- venue box start-->
                <div class="vendor-image"><!-- venue pic --> 
                    <a href="#"><img class="img-responsive" alt="wedding venue" src="http://albumso.com/public_html/images/vendor-1.jpg"></a>
                    <div class="favourite-bg"><a class="" href="#"><i class="fa fa-heart"></i></a></div>
                </div>
                <!-- /.venue pic -->
                <div class="vendor-detail"><!-- venue details -->
                    <div class="caption"><!-- caption -->
                        <h2><a class="title" href="#">Venue Vendor Title</a></h2>
            ...
            <div class="col-md-3 vendor-box"><!-- venue box start-->
                <div class="vendor-image"><!-- venue pic --> 
                    <a href="#"><img class="img-responsive" alt="wedding venue" src="http://albumso.com/public_html/images/vendor-2.jpg"></a>
                    <div class="favourite-bg"><a class="" href="#"><i class="fa fa-heart"></i></a></div>
                </div>
                <!-- /.venue pic -->
                <div class="vendor-detail"><!-- venue details -->
            ...
            <div class="col-md-3 vendor-box"><!-- venue box start-->
                <div class="vendor-image"><!-- venue pic --> 
                    <a href="#"><img class="img-responsive" alt="wedding venue" src="http://albumso.com/public_html/images/vendor-3.jpg"></a>
                    <div class="favourite-bg"><a class="" href="#"><i class="fa fa-heart"></i></a></div>
                </div>
                <!-- /.venue pic -->
                <div class="vendor-detail"><!-- venue details -->
            ...
            <div class="col-md-3 vendor-box"><!-- venue box start-->
                <div class="vendor-image"><!-- venue pic --> 
                    <a href="#"><img class="img-responsive" alt="wedding venue" src="http://albumso.com/public_html/images/vendor-4.jpg"></a>
                    <div class="favourite-bg"><a class="" href="#"><i class="fa fa-heart"></i></a></div>
                </div>
                <!-- /.venue pic -->
                <div class="vendor-detail"><!-- venue details -->
            ...
            <div class="col-md-3 vendor-box"><!-- venue box start-->
                <div class="vendor-image"><!-- venue pic --> 
                    <a href="#"><img class="img-responsive" alt="wedding venue" src="http://albumso.com/public_html/images/vendor-5.jpg"></a>
                    <div class="favourite-bg"><a class="" href="#"><i class="fa fa-heart"></i></a></div>
                </div>
                <!-- /.venue pic -->
                <div class="vendor-detail"><!-- venue details -->
            ...
            <div class="col-md-3 vendor-box"><!-- venue box start-->
                <div class="vendor-image"><!-- venue pic --> 
                    <a href="#"><img class="img-responsive" alt="wedding venue" src="http://albumso.com/public_html/images/vendor-6.jpg"></a>
                    <div class="favourite-bg"><a class="" href="#"><i class="fa fa-heart"></i></a></div>
                </div>
                <!-- /.venue pic -->
                <div class="vendor-detail"><!-- venue details -->
            ...
            <div class="col-md-3 vendor-box"><!-- venue box start-->
                <div class="vendor-image"><!-- venue pic --> 
                    <a href="#"><img class="img-responsive" alt="wedding venue" src="http://albumso.com/public_html/images/vendor-7.jpg"></a>
                    <div class="favourite-bg"><a class="" href="#"><i class="fa fa-heart"></i></a></div>
                </div>
                <!-- /.venue pic -->
                <div class="vendor-detail"><!-- venue details -->
            ...
            <div class="col-md-3 vendor-box"><!-- venue box start-->
                <div class="vendor-image"><!-- venue pic --> 
                    <a href="#"><img class="img-responsive" alt="wedding venue" src="http://albumso.com/public_html/images/vendor-8.jpg"></a>
                    <div class="favourite-bg"><a class="" href="#"><i class="fa fa-heart"></i></a></div>
                </div>
                <!-- /.venue pic -->
                <div class="vendor-detail"><!-- venue details -->
